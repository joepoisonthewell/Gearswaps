...
function init_gear_sets()
    ...
    sets.precast.JA['Boost'] = {hands="Temple Gloves +1"}
    sets.precast.JA['Dodge'] = {feet="Temple Gaiters +1"}
    sets.precast.JA['Focus'] = {head="Temple Crown +1"}
    ...
    sets.precast.WS['Howling Fist']    = {ammo="Black Tathlum",
    head="Maat's Cap",
    body="Kirin's Osode",
    ...
    sets.precast.WS['Dragon Kick']     = {ammo="Black Tathlum",
    head="Maat's Cap",
    body="Kirin's Osode",
    hands="Alkyoneus's Brc.",
    legs="Hachiryu Haidate",
	...
	sets.engaged.SomeAcc = {ammo="Lucky Coin",
    head="Arh. Jinpachi +1",
    body="Arhat's Gi +1",
    hands="Usukane Gote",
    legs="Byakko's Haidate",
