...
function init_gear_sets()
    ...
    sets.precast.JA['Flee'] = {feet="Rogue Poulaines +1"}
    ...
    sets.precast.WS['Mercy Stroke'] = {ammo="Fire Bomblet",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Skadi's Cuirie",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.precast.WS['Rudra\'s Storm'] = set_combine(sets.precast.WS, {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Skadi's Cuirie",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.idle.DT = set_combine(sets.idle, {ammo="Fire Bomblet",
    head="Walahra Turban",
    body="Rapparee Harness",
    hands="Dst. Mittens +1",
    legs="Dst. Subligar +1",
