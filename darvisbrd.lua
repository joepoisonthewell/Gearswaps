...
function init_gear_sets()
    ...
    sets.precast.FC.BardSong = { main="Terra's Staff",
    sub="Earth Grip",
    range="Gjallarhorn",
    head="Zenith Crown +1",
    body="Sheikh Manteel",
    ...
    sets.precast.WS['Mercy Stroke'] = { range="Gjallarhorn",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.midcast.SongDebuff = { main="Alkalurops",
    sub="Vivid Strap +1",
    range="Gjallarhorn",
    head="Brd. Roundlet +1",
    ...
    sets.midcast.Stoneskin = {    range="Gjallarhorn",
    head="Maat's Cap",
    body="Marduk's Jubbah",
    hands="Marduk's Dastanas",
    legs="Mahatma Slops",
