...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Incantor Stone",
        head="Cizin Helm",ear2="Loquacious Earring",ring2="Prolix Ring",legs="Homam Cosciales"}
    ...
    sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Tiphia Sting",
    head="Hecatomb Cap +1",
    body="Zahak's Mail",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.precast.WS['Atonement'] = {ammo="Charitoni Sling",
    head="Bahamut's Mask",
    body="Hydra Haubert",
    hands="I.R. Dastanas",
    legs="Iron Ram Hose",
    ...
    sets.midcast.Enmity = {ammo="Charitoni Sling",
    head="Bahamut's Mask",
    body="Hydra Haubert",
    hands="I.R. Dastanas",
    legs="Iron Ram Hose",
    ...
    sets.midcast.Cure = {ammo="Charitoni Sling",
    head="Bahamut's Mask",
    body="Hydra Haubert",
    hands="I.R. Dastanas",
    legs="Iron Ram Hose",
    ...
    sets.idle.Town = { ammo="Charitoni Sling",
    head="Blood Mask",
    body="Ares' Cuirass",
    hands="Heavy Gauntlets",
    legs="Blood Cuisses",
    ...
    sets.defense.PDT = {ammo="Charitoni Sling",
    head="Valhalla Helm",
	...
	sets.defense.HP = { ammo="Charitoni Sling",
    head="Valhalla Helm",
    ...
    sets.engaged = {ammo="Fenrir's Stone",
    head="Walahra Turban",
    body="Homam Corazza",
    hands="Dusk Gloves +1",
    ...
    sets.engaged.Acc = {ammo="Charitoni Sling",
    head="Valhalla Helm",
    body="Valhalla Brstplate",
    hands="Heavy Gauntlets",
    legs="Dst. Subligar +1",
    ...
    sets.engaged.DW = { ammo="Charitoni Sling",
    head="Valhalla Helm",
    body="Blood Scale Mail",
    hands="Heavy Gauntlets",
    legs="Bahamut's Hose",
