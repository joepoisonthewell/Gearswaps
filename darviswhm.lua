...
function init_gear_sets()
    ...
    sets.precast.FC = { main="Chatoyant Staff",
    sub="Vivid Strap +1",
    ammo="White Tathlum",
    head="Marduk's Tiara",
    ...
    sets.midcast.FC = {ammo="White Tathlum",
    head="Walahra Turban",
    ...
    sets.midcast.Regen = set_combine(sets.midcast.EnhancingDuration, {body="Cleric's Bliaut +1",
        })
    ...
    sets.midcast.Stoneskin = set_combine(sets.midcast.EnhancingDuration, { main="Mistilteinn",
    sub="Muse Tariqah",
    ammo="White Tathlum",
    head="Maat's Cap",
    body="Marduk's Jubbah",
    ...
    sets.midcast.BarElement = set_combine(sets.midcast['Enhancing Magic'], {main="Terra's Staff",
    sub="Vivid Strap +1",
    ammo="White Tathlum",
    head="Walahra Turban",
    ...
    sets.midcast['Divine Magic'] = { main="Chatoyant Staff",
    sub="Vivid Strap +1",
    ammo="Sturm's Report",
    head="Maat's Cap",
    body="Marduk's Jubbah",
    ...
    sets.midcast.Banish = set_combine(sets.midcast['Divine Magic'],  {main="Chatoyant Staff",
    sub="Vivid Strap +1",
    ammo="Sturm's Report",
    head="Maat's Cap",
    body="Marduk's Jubbah",
    ...
    sets.midcast.Holy = {main="Chatoyant Staff",
    sub="Vivid Strap +1",
    ammo="Sturm's Report",
    head="Maat's Cap",
    body="Marduk's Jubbah",
    ...
    sets.idle.DT = set_combine(sets.idle, {main="Terra's Staff",
    sub="Vivid Strap +1",
    ammo="White Tathlum",
    head="Walahra Turban",
    body="Dalmatica +1",
    ...
    sets.idle.MEva = set_combine(sets.idle.DT, {main="Terra's Staff",
    sub="Vivid Strap +1",
    ammo="White Tathlum",
    head="Walahra Turban",
    body="Dalmatica +1",
    ...
    sets.idle.Town = set_combine(sets.idle, {main="Terra's Staff",
    sub="Vivid Strap +1",
    ammo="White Tathlum",
    head="Walahra Turban",
    body="Dalmatica +1",
