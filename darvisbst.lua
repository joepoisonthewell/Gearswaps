...
function init_gear_sets()
    ...
    sets.precast.JA['Reward'] = { ammo="Tiphia Sting",
    head="Maat's Cap",
    body="Kirin's Osode",
    hands="Hct. Mittens +1",
    ...
    sets.precast.WS['Onslaught'] = set_combine(sets.precast.WS, {ammo="Tiphia Sting",
    head="Hecatomb Cap +1",
    body="Armada Hauberk",
    hands="Hct. Mittens +1",
    legs="Byakko's Haidate",
    ...
    -- RESTING
    sets.resting = { ammo="Fenrir's Stone",
    ...
    sets.idle.Pet = { ammo="Fenrir's Stone",
    head="Darksteel Cap +1",
    body="Dst. Harness +1",
    hands="Dst. Mittens +1",
    legs="Dst. Subligar +1",
    ...
    sets.idle.Pet.Engaged = {ammo="Tiphia Sting",
    head="Darksteel Cap +1",
    body="Haubergeon",
    ...
    sets.engaged = {ammo="Tiphia Sting",
    head="Walahra Turban",
    body="Armada Hauberk",
    hands="Dusk Gloves +1",
    legs="Byakko's Haidate",
    ...
    sets.engaged.Acc = {ammo="Tiphia Sting",
    head="Walahra Turban",
    body="Armada Hauberk",
    hands="Dusk Gloves +1",
    legs="Byakko's Haidate",
