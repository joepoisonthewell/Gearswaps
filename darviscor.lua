...
function init_gear_sets()
    ...
    sets.precast.JA['Random Deal'] = {body="Commodore Frac +1"}

    
    sets.precast.CorsairRoll = {head="Commodore Tricorne +1",hands="Navarch's Gants +2"}
    ...
    sets.precast.WS = { head="Gnadbhod's Helm",
    body="Skadi's Cuirie",
    ...
    sets.precast.WS['Evisceration'] = {head="Gnadbhod's Helm",
    body="Skadi's Cuirie",
    ...
    sets.precast.WS['Slug Shot'] = {head="Gnadbhod's Helm",
    body="Skadi's Cuirie",
    hands="Blood Fng. Gnt.",
    legs="Skadi's Chausses",
    ...
    sets.precast.WS['Wildfire'] = {head="Cor. Tricorne +1",
    body="Skadi's Cuirie",
    hands="Blood Fng. Gnt.",
    legs="Denali Kecks",
    ...
    sets.midcast.CorsairShot = { head="Cor. Tricorne +1",
    body="Skadi's Cuirie",
    hands="Blood Fng. Gnt.",
    legs="Denali Kecks",
    feet="Denali Gamashes",
    ...
    -- Ranged gear
    sets.midcast.RA = {head="Zha'Go's Barbut",
    body="Skadi's Cuirie",
    hands="Blood Fng. Gnt.",
    legs="Skadi's Chausses",
    feet="Skadi's Jambeaux",
    ...
    sets.idle.Town = {head="Blood Mask",
    body="Dst. Harness +1",
    hands="Denali Wristbands",
    legs="Dst. Subligar +1",
    feet="Skadi's Jambeaux",
    ...
    -- Normal melee group
    sets.engaged.Melee = { head="Walahra Turban",
    body="Skadi's Cuirie",
    hands="Dusk Gloves +1",
    legs="Skadi's Chausses",
    ...
    sets.engaged.Melee.DW = { head="Walahra Turban",
    body="Skadi's Cuirie",
    hands="Dusk Gloves +1",
    legs="Skadi's Chausses",
    feet="Dusk Ledelsens +1",
