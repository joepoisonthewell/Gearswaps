...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Metsu'] = set_combine(sets.precast.WS, { ammo="Fire Bomblet",
    head="Gnadbhod's Helm",
    body="Kirin's Osode",
    hands="Nin. Tekko +1",
    legs="Byakko's Haidate",
    ...
    sets.midcast.ElementalNinjutsu = {ammo="Sturm's Report",
    ...
    sets.midcast.EnfeeblingNinjutsu = { ammo="Sturm's Report",
...
--    sets.resting = {}
    ...
    sets.Kiting = {feet="Ninja Kyahan +1"}

    sets.DayMovement = {feet="Danzo sune-ate"}
    sets.NightMovement = {feet="Ninja Kyahan +1"}
