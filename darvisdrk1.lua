...
function init_gear_sets()
    ...
    sets.precast.JA['Souleater'] = {head="Chaos Burgeonet +1"}
    ...
    sets.precast.WS['Catastrophe'] = set_combine(sets.precast.WS, {ammo="Fire Bomblet",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    hands="Alkyoneus's Brc.",
    legs="Ares' Flanchard",
    ...
    sets.precast.WS['Cross Reaper'] = set_combine(sets.precast.WS, { ammo="Fire Bomblet",
    head="Hecatomb Cap +1",
    body="Armada Hauberk",
    hands="Hct. Mittens +1",
    legs="Ares' Flanchard",
    ...
    sets.precast.WS['Guillotine'] = set_combine(sets.precast.WS['Resolution'], {ammo="Fire Bomblet",
    head="Hecatomb Cap +1",
    body="Armada Hauberk",
    hands="Hct. Mittens +1",
    legs="Ares' Flanchard",
    ...
    sets.midcast['Enfeebling Magic'] = { ammo="Sturm's Report",
    head="Blood Mask",
    body="Chs. Cuirass +1",
    hands="Dusk Gloves +1",
    ...
    sets.midcast['Dread Spikes'] = set_combine(sets.midcast['Dark Magic'], {ammo="Verthandi's Gem",
    head="Walahra Turban",
    ...
    sets.idle.Town = set_combine(sets.idle, {ammo="Verthandi's Gem",
    head="Blood Mask",
    body="Ares' Cuirass",
    hands="Dst. Mittens +1",
    legs="Blood Cuisses",
    ...
    sets.engaged.LowAcc = set_combine(sets.engaged, { ammo="Fire Bomblet",
    head="Ace's Helm",
    body="Askar Korazin",
    ...
    sets.engaged.Apocalypse = set_combine(sets.engaged, {ammo="Fire Bomblet",
    head="Ace's Helm",
    body="Askar Korazin",
    hands="Dusk Gloves +1",
    legs="Homam Cosciales",
    ...
    sets.engaged.Apocalypse.LowAcc = set_combine(sets.engaged.Apocalypse, { ammo="Fire Bomblet",
    head="Ace's Helm",
    body="Askar Korazin",
    hands="Ares' Gauntlets",
    legs="Ares' Flanchard",
