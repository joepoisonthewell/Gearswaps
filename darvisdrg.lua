...
function init_gear_sets()
    ...
    sets.precast.JA['High Jump'] = {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    hands="Hct. Mittens +1",
    legs="Wym. Brais +1",
    ...
    sets.precast.FC = {
        ammo="Sapience Orb", --2
        head="Drachen Armet", --14
        body="Sacro Breastplate", --10
        hands="Leyline Gloves", --8
        legs="Homam Cosciales", --6
	...
	sets.precast.HealingBreath = {  ammo="Charitoni Sling",
    head="Drn. Armet +1",
    body="Wyvern Mail",
    ...
    neck="Chanoix's Gorget",
    waist="Ocean Sash",
    left_ear="Pigeon Earring +1",
    right_ear="Pigeon Earring +1",
    ...
    sets.precast.WS['Wheeling Thrust'] = { ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
   ...
   --sets.precast.WS['Camlann\'s Torment'].Acc = set_combine(sets.precast.WS)['Camlann\'s Torment'], {}
    ...
    sets.precast.WS['Drakesbane'] = set_combine(sets.precast.WS,  {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Zahak's Mail",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.precast.WS['Geirskogul'] = set_combine(sets.precast.WS, { ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    hands="Alkyoneus's Brc.",
    legs="Ares' Flanchard",
    ...
    sets.precast.WS['Impulse Drive'] = set_combine(sets.precast.WS['Camlann\'s Torment'], {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Hct. Harness +1",
    hands="Alkyoneus's Brc.",
    legs="Ares' Flanchard",
    ...
    sets.precast.WS['Stardiver'] = set_combine(sets.precast.WS, {ammo="Black Tathlum",
    head="Hecatomb Cap +1",
    body="Zahak's Mail",
    hands="Hct. Mittens +1",
    legs="Hct. Subligar +1",
    ...
    sets.midcast.HealingBreath = { ammo="Charitoni Sling",
    head="Wym. Armet +1",
    body="Wyvern Mail",
    hands="Ostreger Mitts",
    legs="Drn. Brais +1",
    ...
    sets.midcast.ElementalBreath = { ammo="Charitoni Sling",
    head="Wym. Armet +1",
    body="Wyvern Mail",
    hands="Ostreger Mitts",
    legs="Drn. Brais +1",
    ...
    sets.idle.DT = set_combine(sets.idle, { ammo="Black Tathlum",
    head="Blood Mask",
    body="Wym. Mail +1",
    ...
    sets.idle.Pet = set_combine(sets.idle, {ammo="Charitoni Sling",
    head="Blood Mask",
    body="Ares' Cuirass",
    hands="Dst. Mittens +1",
    legs="Blood Cuisses",
    ...
    sets.idle.DT.Pet = set_combine(sets.idle.Pet, { ammo="Black Tathlum",
    head="Blood Mask",
    body="Wym. Mail +1",
    hands="Homam Manopolas",
    legs="Blood Cuisses",
    ...
    sets.idle.Town = set_combine(sets.idle, { ammo="Black Tathlum",
    head="Blood Mask",
    body="Wym. Mail +1",
    hands="Homam Manopolas",
    legs="Blood Cuisses",
    ...
    sets.engaged.LowAcc = { ammo="Tiphia Sting",
